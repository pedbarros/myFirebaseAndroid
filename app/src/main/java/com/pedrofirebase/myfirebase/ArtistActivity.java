...
import com.pedrofirebase.myfirebase.adapter.TrackAdapter;
...
public class ArtistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        * */
        databaseTracks = FirebaseDatabase.getInstance().getReference("tracks").child(intent.getStringExtra("id"));
        ...
        textViewArtist.setText(intent.getStringExtra("name"));
